...
public class PageDTO {
	...
	private Criteria cri;			// 현재 브라우저 화면에서 전송하는 파라미터 전송
	private AdminCriteria mcri;
	...
	public PageDTO(AdminCriteria mcri, int totalAmount) {
		this.mcri = mcri;
		...
		//--Step.0 : 페이징 처리를 위한 공통변수 생성하기
		//----------------------------------------------------------//
		int currPage = mcri.getCurrPage();
		int amount = mcri.getAmount();
		int pagesPerPage = mcri.getPagesPerPage();
