	...
	<div id="pagination">
		...
		<form action="#" id="paginationForm">
			...
			<c:if test="${pageMaker.prev}">
				<li class="page-item"><a class="page-link" href="/box/list?currPage=${pageMaker.startPage-1}&amount=${cri.amount}&pagesPerPage=${cri.pagesPerPage}&member_id=${member_id}"><i class="fas fa-angle-left"></i></a></li>
			</c:if>
			...
			<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
				...
				<c:choose>
					...
					<c:otherwise>
						<li class="page-item"><a class="page-link" href="/box/list?currPage=${pageNum}&amount=${cri.amount}&pagesPerPage=${cri.pagesPerPage}&member_id=${member_id}">${pageNum}</a></li>
					</c:otherwise>
				</c:choose>
			</c:forEach>
			...
			<c:if test="${pageMaker.next}">
				<li class="page-item"><a class="page-link" href="/box/list?currPage=${pageMaker.endPage+1}&amount=${cri.amount}&pagesPerPage=${cri.pagesPerPage}&member_id=${member_id}"><i class="fas fa-angle-right"></i></a></li>
			</c:if>
			</ul>
		</form>
	</div>
