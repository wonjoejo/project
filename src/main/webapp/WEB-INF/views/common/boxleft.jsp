...
<div class="side-menu">
    ...
    <div class="menu">
        <span class="menu-item active"><a href="${pageContext.request.contextPath}/box/list?member_id=${sessionScope.member_id}"><i class="far fa-list-alt"></i> 나의 박스</a></span>
        <span class="menu-item inactive"><a href="${pageContext.request.contextPath}/product/listPerPage?box_no=${box.box_no}"><i class="far fa-plus-square"></i> 물품 리스트</a></span>
        <span class="menu-item inactive"><a href="#"><i class="far fa-envelope"></i> 카테고리</a></span>
