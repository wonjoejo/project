        ...
        <div class="page-wrapper">
            ...
            >
                ...
                <div class="buttons">
                    ...
                    <button class="submit-btn hvr-float" type="submit" id="submitBtn">
...
<%-- boxPermissionList --%>
<%--<c:forEach items="${boxPermissionList}" var="permissionList">--%>
<%--    <input type="text" id="master_per" name="master_per" value="${permissionList.master_per}">--%>
<%--</c:forEach>--%>
    ...
    <div class="modal-window">
        ...
        <form id="deleteForm" action="/member/delete" method="post">
            ...
            <div class="modalbuttons">
                <button class="delete-btn hvr-float" type="submit" id="alertDeleteBtn">
